...
3  | Jan 26–Feb  1 | {doc}`04/notes` ({doc}`lab <04/lab>`)                           | Guest lecture: {doc}`5/notes` ([homework 1](https://classroom.github.com/a/pF35huEj))
4  | Feb  2–Feb  8 | {doc}`06/notes` ({doc}`lab <06/lab>`)                           | {doc}`07/notes` ({doc}`lab <07/lab>`)
